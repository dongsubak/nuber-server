...
import { IsEmail } from "class-validator"; //https://github.com/typestack/class-validator
import { 
    BaseEntity, 
    BeforeInsert, 
    BeforeUpdate,
...
class User extends BaseEntity {
    ...
    ridesAsPassenger: Ride[]; //ridesAsPassenger is column

    @OneToMany(type => Ride, ride => ride.driver)
    ridesAsDriver: Ride[]; //ridesAsDriver is column
